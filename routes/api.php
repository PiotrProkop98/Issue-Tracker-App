...
Route::post('/issues/mark-as-finished', [IssueController::class, 'markAsFinished'])->middleware('auth:sanctum');
Route::get('/issues/work-in-progress', [IssueController::class, 'workInProgress'])->middleware('auth:sanctum');
...
Route::get('/issue/start-working/{issue_id}', [IssueController::class, 'startWorking'])->middleware('auth:sanctum');